...
urlpatterns = [
    ...
    url(r'^SupplierInvoiceCollectionListJson/$', SupplierInvoiceCollectionListJson.as_view(),
        name='SupplierInvoiceCollectionListJson'),
    url(r'^SupplierCollectionListCashJson/$', SupplierCollectionListCashJson.as_view(),
        name='SupplierCollectionListCashJson'),
    url(r'^SupplierCollectionAdminListCashJson/$', SupplierCollectionAdminListCashJson.as_view(),
        name='SupplierCollectionAdminListCashJson'),
    url(r'^SupplierCollectionListChequeJson/$', SupplierCollectionListChequeJson.as_view(),
        name='SupplierCollectionListChequeJson'),
    url(r'^SupplierCollectionAdminListChequeJson/$', SupplierCollectionAdminListChequeJson.as_view(),
        name='SupplierCollectionAdminListChequeJson'),
    ...
    url(r'^take_collection_invoice_supplier_api/$', take_collection_invoice_supplier_api,
        name='take_collection_invoice_supplier_api'),
    ...
    url(r'^delete_collection_supplier_invoice_api/$', delete_collection_supplier_invoice_api,
        name='delete_collection_supplier_invoice_api'),
