...
urlpatterns = [
    ...
    url(r'^EmployeeListForAttendanceJson/$', EmployeeListForAttendanceJson.as_view(),
        name='EmployeeListForAttendanceJson'),
    url(r'^EmployeeListForAttendanceAdminJson/$', EmployeeListForAttendanceAdminJson.as_view(),
        name='EmployeeListForAttendanceAdminJson'),
    url(r'^EmployeeListForAttendanceAdminBasicJson/$', EmployeeListForAttendanceAdminBasicJson.as_view(),
        name='EmployeeListForAttendanceAdminBasicJson'),
