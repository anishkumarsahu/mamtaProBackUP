...
urlpatterns = [
    ...
    url(r'^generate_net_report_credit_admin/$', generate_net_report_credit_admin,
        name='generate_net_report_credit_admin'),
    ...
    url(r'^generate_monthly_report_staff_advance_admin/$', generate_monthly_report_staff_advance_admin,
        name='generate_monthly_report_staff_advance_admin'),
    url(r'^generate_collection_report_for_cashier/$', generate_collection_report_for_cashier,
        name='generate_collection_report_for_cashier'),
